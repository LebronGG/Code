...
def make_args():
    ...
    parser.add_argument('-m', '--metadata_file', type=str,default='E:/py/test/file/eval.csv')
    parser.add_argument('-o', '--output', type=str,default='E:/py/test/shard')
    parser.add_argument('-l', '--labels', type=str,default='E:/py/test/file/dog.json')
...
def main():
    ...
    for T in tqdm(metadata.itertuples()):
        ...
        if bounding_boxes is not None:
            boxes = bounding_boxes.get(T.filename, np.empty((0, 4), dtype='float32'))
